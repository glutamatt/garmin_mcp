    ...
    async def get_available_features(ctx: Context) -> dict:
        ...
        return {
            ...
            "features": [
                ...
                {"domain": "training", "tools": ["get_training_status", "get_training_readiness", "get_endurance_score", "get_fitnessage_data"]},
                ...
                {"domain": "workouts", "tools": ["get_workouts", "get_workout_by_id", "get_scheduled_workouts", "schedule_workout"]},
            ]
        }
